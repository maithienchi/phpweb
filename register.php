...
<?php if(isset($_POST['displayName']) && isset($_POST['email']) && isset($_POST['password'])
    && isset($_POST['gender']) && isset($_POST['phone']) && isset($_POST['birthday_day']) && isset($_POST['birthday_month'])
    && isset($_POST['birthday_year'])&& isset($_POST['agree-tos'])): ?>
<?php 
...
$user =findUserByEmail($email);
    ...
    if(!$user)
    {
        $newUserId=createUser($displayName, $email,$NamSinh,$gender,$phone, $password);
